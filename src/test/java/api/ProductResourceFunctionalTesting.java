...
public class ProductResourceFunctionalTesting {
    ...
    public void testSetProductAsDiscontinued() {
        ...
        patchChangeDescription.setPath(Uris.PRODUCTS_DISCONTINUED);
    ...
    public void testGenerateBarcodesPdf() {
        ...
        new RestBuilder<Object>(restService.getUrl()).path(Uris.PRODUCTS + Uris.PRODUCTS_BARCODES).body(productBarcodeWrappers).post().build();
    }
