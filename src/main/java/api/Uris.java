...
public class Uris {
    ...
    public static final String PRODUCT_CODE_ID = "/{code}";
    ...
    public static final String TICKET_DATE_ID = "/{date}";

    public static final String TICKET_REFERENCE_ID = "/{reference}";
    ...
    public static final String PRODUCT_BARCODES = "/barcodes";
